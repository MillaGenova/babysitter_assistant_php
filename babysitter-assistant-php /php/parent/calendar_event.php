...
if (isset($_POST['add_comment'])) {
    ...
    mysqli_query($conn, "UPDATE `calendar` SET comment = '$comment' WHERE eventId = '$event_id'") or die('query failed');
        ...
        <div class="content">
            <div class="add-child-container">
                ...
                <form action="" method="POST">
                    ...
                    <br>
                    <input type="submit" name="add_comment" value="Add Comment" class="option-btn">
                </form>
